...
# 
# <img src="nb_image/U-net_example_wikipedia.png" alt="U-net Image" width="600"/>
# 
...
# 
# **NOTE**: If you wish to see the contents of the `helper_utils.py` file, click on `File --> Open...` from the top left menu of the notebook.
...
model_2 = helper_utils.unet_model_3d(
    depth=2,
